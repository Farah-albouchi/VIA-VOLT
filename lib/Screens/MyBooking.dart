                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return FutureBuilder<String?>(
                              future: getStationName(booking[
                                  'serviceId']), // Get the station name asynchronously
                              builder: (context, snapshot) {
                                if (snapshot.connectionState ==
                                  ...
                                  return Text(
                                      'Error: ${snapshot.error}'); // Show error if fetching station name fails
                                } else {
                                  String? stationName = snapshot
                                      .data; // Get the fetched station name
                                  return Padding(
                                        ...
                                        children: <Widget>[
                                          ...
                                          Row(
                                            children: <Widget>[
                                              ...
                                              Text(
                                                stationName ??
                                                    'Station Name Not Found', // Display the station name or a default message
                                                style: TextStyle(
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.bold,
                                                ),
